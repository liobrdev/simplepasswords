  ...
  render() {
    const breadcrumbList: IBreadcrumbListItem[] = [
      ...
      },
      {
        ...
        item: "https://simplepasswords.app/terms"
      }
    ];
    ...
    return (
      <>
        <Head>
          <title>Terms and Conditions - SimplePasswords</title>
        ...
        <main className='Page Page--legal'>
          ...
          <div className='LegalText'>
            ...
            <ul>
              <li>
                <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named SimplePasswords</p>
              </li>
              <li>
              ...
              <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SimplePasswords.</p>
              </li>
              <li>
              ...
              <li>
                <p><strong>Website</strong> refers to SimplePasswords, accessible from <a href="https://simplepasswords.app" rel="external nofollow noopener noreferrer" target="_blank">https://simplepasswords.app</a></p>
              </li>
              <li>
